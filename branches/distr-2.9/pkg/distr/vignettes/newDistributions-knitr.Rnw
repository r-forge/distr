...
%
\xdef\RforgeURL{https://r-forge.r-project.org/scm/viewvc.php/pkg/distr/vignettes/newDistributions-knitr.Rnw?root=distr&revision=\svnfilerev}
\newcommand{\RForgeVignetteURL}{\url{\RforgeURL}}%
...
\footnotesize\sffamily
 ...
 R-Forge Source:\> \parbox[t]{6cm}{\RForgeVignetteURL}\\[1.2ex]
